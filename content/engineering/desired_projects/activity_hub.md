...
This is inline with requirements proposed for the [[engineering/infrastructure_essentials/logos_js_sdk|Logos JS SDK]] in this [forum post](https://forum.vac.dev/t/why-a-web-sdk-is-critical-for-logos-adoption/583/10).
...
- I want my minutes to be backed up for the future, using [[engineering/infrastructure_essentials/logos_storage|Logos Storage]].
- The [[engineering/infrastructure_essentials/logos_js_sdk|Logos JS SDK]] does not support uploading data to [[engineering/infrastructure_essentials/logos_storage|Logos Storage]].
...
- However, only recent minutes are available via [[engineering/infrastructure_essentials/logos_messaging|Logos Messaging]] via the [[engineering/infrastructure_essentials/logos_js_sdk|Logos JS SDK]]
- Data retrieval from [[engineering/infrastructure_essentials/logos_storage|Logos Storage]] is not available in the browser
- To access older minutes store on [[engineering/infrastructure_essentials/logos_storage|Logos Storage]], I need to install the Logos App.
- However, I was still able to get a preview of my Logos Circle activity without additional software.

Note that the example above assumed specific limitations (no browser access to [[engineering/infrastructure_essentials/logos_storage|Logos Storage]]). These limitations may be lifted in the future, allowing deeper Logos experience in the browser.
