...
An extension of the [[engineering/infrastructure_essentials/logos_js_sdk|logos_js_sdk]] to enable web app built with it run in standard browsers, with limited access to Logos functionality. This is to enable onboarding of new users with minimal friction, specifically relevant for the [[engineering/desired_projects/activity_hub|activity_hub]].
...
- Access recent messages via [[engineering/infrastructure_essentials/logos_messaging|Logos Messaging]] (limited history)
...
- Existing JavaScript implementation of [[engineering/infrastructure_essentials/logos_messaging|Logos Messaging]] protocols

### Usability

- Provide intuitive API matching [[engineering/infrastructure_essentials/logos_js_sdk|Logos JS SDK]] where possible
...
- [[engineering/desired_projects/activity_hub|Activity Hub]] browser version for newcomers
- Preview/read-only interfaces for Logos data
- Landing pages with live Logos network stats
- Onboarding funnels to convert users to [[engineering/infrastructure_essentials/logos_js_sdk|Logos App]]
...
**Limitations (compared to [[engineering/infrastructure_essentials/logos_js_sdk|Logos JS SDK]]):**
...
- [[engineering/infrastructure_essentials/logos_messaging|Logos Messaging]] via public relays
- Logos Storage HTTP gateways (read-only)
- Browser wallet extensions (MetaMask, etc.)
- Onboarding funnel to [[engineering/infrastructure_essentials/logos_js_sdk|Logos JS SDK]]
...
3. **Installs Logos App** to access [[engineering/infrastructure_essentials/logos_js_sdk|full functionality]]
