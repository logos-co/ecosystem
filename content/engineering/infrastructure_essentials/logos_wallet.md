...
- Enable one-click connection to dApps via [[engineering/infrastructure_essentials/logos_js_sdk|Logos JS SDK]]
...
- [[engineering/infrastructure_essentials/logos_messaging|Logos Messaging]] for transaction notifications and address book (optional)
- [[engineering/infrastructure_essentials/logos_storage|Logos Storage]] for encrypted wallet backups (optional)
...
- [[engineering/infrastructure_essentials/logos_js_sdk|Logos JS SDK]] for dApp wallet connection and transaction signing
- [[engineering/infrastructure_essentials/logos_core|Logos Core]] as wallet module in Logos App
- [[engineering/desired_projects/multisig|Multisig]] for multi-signature wallet functionality
- [[engineering/desired_projects/private_dex|Private DEX]], [[engineering/desired_projects/private_lending|Private Lending]], and other DeFi protocols for asset management
- Hardware wallets (Ledger, Trezor, Keystone) via standardized integration APIs
- [[engineering/application_essentials/logos_core_devex|Development Journey]] for browser extension development
