...
This is inline with requirements proposed for the [[Logos Web SDK]] in this [forum post](https://forum.vac.dev/t/why-a-web-sdk-is-critical-for-logos-adoption/583/10).
...
- To access older minutes store on [[Logos Storage]], I need to install the [[Logos Messaging]].
